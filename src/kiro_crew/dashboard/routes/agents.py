...
def register(app: web.Application) -> None:
    ...
    app.router.add_get("/api/members/templates", handlers.api_member_templates)
    ...
    app.router.add_get("/api/members/{slug}/briefing", handlers.api_member_briefing_get)
    ...
    app.router.add_post("/api/members/{member}/fire", handlers.api_member_fire)
